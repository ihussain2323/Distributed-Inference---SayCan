...
# Auto-setup script for Llama Distributed Inference with Ray
# Usage: source setup_llama_ray.sh

echo "🚀 Setting up Llama Distributed Inference environment..."
...
# Navigate to the Llama distributed inference directory
cd "Distributed Inference/Ray Distributed/llama distributed inference"
